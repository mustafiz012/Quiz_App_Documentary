	...
	<div id="wrapper">
        ...
        <div id="containerHolder">
			<div id="container">
        		<div id="sidebar">
                	<ul class="sideNav">
                    	<li><a href="manage_levels.php" <?php if($currentFile=="manage_levels.php")
															{?>class="active"<?php }?>>Manage Levels</a></li>                    	 
                    	<li><a href="manage_questions.php" <?php if($currentFile=="manage_questions.php")
